...
--------------------------
- R\. Kaushik, K\. Chatzilygeroudis, \.-B\. Mouret (2018). *Multi-objective Model-based Policy Search for Data-efficient Learning with Sparse Rewards.* Proc. of Conference on Robot Learning (CoRL) `[url] <https://arxiv.org/abs/1806.09351>`_
