...
# -*- coding: utf-8 -*-
#
# ResiBots documentation build configuration file, created by
...
project = 'ResiBots'
copyright = '2015, Jean-Baptiste Mouret'
...
html_theme_options = {
    ...
    'toc_afters': [('Limbo (BO library)', 'http://www.resilient-robots.net/limbo'),
                    ('github page', 'http://github.com/resibots' )
                  ],
}
...
latex_documents = [
  (master_doc, 'ResiBots.tex', 'ResiBots Documentation',
   'Jean-Baptiste Mouret', 'manual'),
]
...
man_pages = [
    (master_doc, 'resibots', 'ResiBots Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ResiBots', 'ResiBots Documentation',
   author, 'ResiBots', 'One line description of project.',
   'Miscellaneous'),
]
